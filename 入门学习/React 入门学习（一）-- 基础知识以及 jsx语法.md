...
```jsx
const VDOM = <h1>Hello,React</h1>/* 不能加引号 */
ReactDOM.render(VDOM,document.querySelector(".test"))
```

### 3. 虚拟 DOM 和真实 DOM 的两种创建方法

#### 3.1 JS 创建虚拟 DOM（一般不用）

```js
//1.创建虚拟DOM,创建嵌套格式的dom （标签名，标签属性，标签内容） h1里加一个span标签
...
>
> 虚拟DOM是object对象，虚拟DOM比较轻，真是DOM比较重
...
//toUpperCase() 把myData转成小写 'hello,react'
```
